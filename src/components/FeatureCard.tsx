  ...
  return (
    ...
    >
      <div className="feature-netflix-card">
        ...
        {/* EMBEDDED METADATA SHIELD PANEL INSIDE VIDEO ELEMENT CARD */}
        <div
      ...
      <style>{`
        .f-fade-in {
          animation: fFadeFrame 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }

        @keyframes fFadeFrame {
        ...
        .f-card-wrapper:hover .feature-netflix-card {
        ...
        /* INTEGRATED DETAILED INFO BOTTOM TRAY */
        .f-glass-meta-panel {
          position: absolute;
        ...
        .f-card-wrapper:hover .f-glass-meta-panel {
          transform: translateY(0);
          background: linear-gradient(to top, rgba(0, 0, 0, 0.98) 0%, rgba(0, 0, 0, 0.88) 60%, rgba(0, 0, 0, 0.4) 100%);
        ...
        .f-card-wrapper:hover .f-action-row {
          opacity: 1;
