...
export default function VideoCard({ video, onSelect, isTvPage = false }: VideoCardProps) {
  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        .card { position: relative; cursor: pointer; overflow: hidden; border-radius: 10px; background: #111; border: 0px solid #000; transition: transform .35s ease, box-shadow .35s ease, border-color .35s ease; box-shadow: 0 10px 25px rgba(0,0,0,.30), 0 25px 50px rgba(0,0,0,.45); }
